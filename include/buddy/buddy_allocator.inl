...
BuddyAllocator<S, B, Tr>::BuddyAllocator()
...
template <size_t S, BufferType B, Tracking Tr>
BuddyAllocator<S, B, Tr>::BuddyAllocator(std::array<std::byte, S>& buf)
...
template <size_t S, BufferType B, Tracking Tr>
BuddyAllocator<S, B, Tr>::~BuddyAllocator() noexcept {
...
template <size_t S, BufferType B, Tracking Tr>
std::byte* BuddyAllocator<S, B, Tr>::allocate(size_t size) noexcept {
...
template <size_t S, BufferType B, Tracking Tr>
void BuddyAllocator<S, B, Tr>::deallocate(std::byte* ptr) noexcept {
  if (ptr == nullptr) {
    return;
  }
...
template <size_t S, BufferType B, Tracking Tr>
void BuddyAllocator<S, B, Tr>::reset() noexcept {
  bitmap.reset();
  free_blocks = {};
  used = 0;
...
template <size_t S, BufferType B, Tracking Tr>
std::string BuddyAllocator<S, B, Tr>::get_state() const noexcept {
  if constexpr (Tr == Tracking::ENABLED) {
    try {
...
template <size_t S, BufferType B, Tracking Tr>
size_t BuddyAllocator<S, B, Tr>::get_used() const noexcept {
  return used;
}

template <size_t S, BufferType B, Tracking Tr>
size_t BuddyAllocator<S, B, Tr>::get_free() const noexcept {
...
template <size_t S, BufferType B, Tracking Tr>
template <typename T>
void BuddyAllocator<S, B, Tr>::deallocate(T* ptr) noexcept {
  deallocate(reinterpret_cast<std::byte*>(ptr));
}

template <size_t S, BufferType B, Tracking Tr>
template <typename T, typename... Args>
T* BuddyAllocator<S, B, Tr>::emplace(Args&&... args) {
...
template <size_t S, BufferType B, Tracking Tr>
template <typename T>
void BuddyAllocator<S, B, Tr>::destroy(T* ptr) noexcept {
...
template <size_t S, BufferType B, Tracking Tr>
Block* BuddyAllocator<S, B, Tr>::get_buddy(Block* block,
...
template <size_t S, BufferType B, Tracking Tr>
void BuddyAllocator<S, B, Tr>::unlink(Block* block, size_t level) noexcept {
  if (block->previous) {
